 ...
 */
class HomepageImage extends \Boodcode\FranceBundle\Entity\HomepageImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Boodcode\\FranceBundle\\Entity\\HomepageImage' . "\0" . 'id', '' . "\0" . 'Boodcode\\FranceBundle\\Entity\\HomepageImage' . "\0" . 'url', '' . "\0" . 'Boodcode\\FranceBundle\\Entity\\HomepageImage' . "\0" . 'alt', '' . "\0" . 'Boodcode\\FranceBundle\\Entity\\HomepageImage' . "\0" . 'thumb', '' . "\0" . 'Boodcode\\FranceBundle\\Entity\\HomepageImage' . "\0" . 'tempThumbname');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HomepageImage $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setThumb(\Symfony\Component\HttpFoundation\File\UploadedFile $thumb)
    {
