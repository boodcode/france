...
$catalogue = new MessageCatalogue('fr', array (
  ...
  array (
    'Hello' => '__Hello',
    'ceci est un test magnifique !' => '__ceci est un test magnifique !',
    'hello' => '__hello',
    'menu.news1' => 'Lorde<br>à la première mondiale de "Hunger Games : La Révolte - Partie 1"',
    'menu.news2' => 'Tilda Swinton<br>aux Governors Awards de Los Angeles',
    'menu.news3' => '“Helena Rubinstein: Beauty Is Power”<br>au Jewish Museum',
    'menu.all' => 'Toutes les news',
