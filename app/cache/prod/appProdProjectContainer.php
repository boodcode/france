...
class appProdProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'boodcode_france.antispam' => 'getBoodcodeFrance_AntispamService',
            'boodcode_france.beta.html' => 'getBoodcodeFrance_Beta_HtmlService',
            'boodcode_france.twig.boodcode_extension' => 'getBoodcodeFrance_Twig_BoodcodeExtensionService',
            'boodcode_france.validator.antiflood' => 'getBoodcodeFrance_Validator_AntifloodService',
            'cache_clearer' => 'getCacheClearerService',
            'cache_warmer' => 'getCacheWarmerService',
            'controller_name_converter' => 'getControllerNameConverterService',
            'data_tables.annotation_reader' => 'getDataTables_AnnotationReaderService',
            'data_tables.manager' => 'getDataTables_ManagerService',
            'data_tables.service' => 'getDataTables_ServiceService',
            'data_tables.twig.extension' => 'getDataTables_Twig_ExtensionService',
    ...
    protected function getBoodcodeFrance_AntispamService()
    {
        $this->services['boodcode_france.antispam'] = $instance = new \Boodcode\FranceBundle\Antispam\BoodcodeAntispam($this->get('swiftmailer.mailer.default'), 50);
        $instance->setLocale('fr');
        return $instance;
    }
    protected function getBoodcodeFrance_Beta_HtmlService()
    {
        return $this->services['boodcode_france.beta.html'] = new \Boodcode\FranceBundle\Beta\betaHTML();
    }
    protected function getBoodcodeFrance_Twig_BoodcodeExtensionService()
    {
        return $this->services['boodcode_france.twig.boodcode_extension'] = new \Boodcode\FranceBundle\Twig\BoodcodeExtension();
    }
    protected function getBoodcodeFrance_Validator_AntifloodService()
    {
        return $this->services['boodcode_france.validator.antiflood'] = new \Boodcode\FranceBundle\Validator\AntifloodValidator($this->get('request_stack'), $this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDataTables_AnnotationReaderService()
    {
        return $this->services['data_tables.annotation_reader'] = new \Doctrine\Common\Annotations\AnnotationReader();
    }
    protected function getDataTables_ManagerService()
    {
        return $this->services['data_tables.manager'] = new \Brown298\DataTablesBundle\Service\TableManager($this, $this->get('data_tables.annotation_reader'), array(0 => 'dataTable'), array(0 => 'DataTables', 1 => 'Model', 2 => 'Entity'), $this->get('doctrine.orm.default_entity_manager'), '');
    }
    protected function getDataTables_ServiceService()
    {
        return $this->services['data_tables.service'] = new \Brown298\DataTablesBundle\Service\ServerProcessService();
    }
    protected function getDataTables_Twig_ExtensionService()
    {
        return $this->services['data_tables.twig.extension'] = new \Brown298\DataTablesBundle\Twig\DataTables();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => 'localhost', 'port' => '3306', 'dbname' => 'france_db', 'user' => 'francounette', 'password' => 'france!Pass2014', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $b, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => (dirname(dirname(dirname(__DIR__))).'/src/Boodcode/FranceBundle/Entity'), 1 => (dirname(dirname(dirname(__DIR__))).'/src/Boodcode/ContactBundle/Entity'), 2 => (dirname(dirname(dirname(__DIR__))).'/src/Boodcode/UserBundle/Entity')));
        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Boodcode\\FranceBundle\\Entity');
        $c->addDriver($b, 'Boodcode\\ContactBundle\\Entity');
        $c->addDriver($b, 'Boodcode\\UserBundle\\Entity');
        $c->addDriver(new \Doctrine\ORM\Mapping\Driver\XmlDriver(new \Doctrine\Common\Persistence\Mapping\Driver\SymfonyFileLocator(array((dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/user-bundle/Resources/config/doctrine/model') => 'FOS\\UserBundle\\Model'), '.orm.xml')), 'FOS\\UserBundle\\Model');
        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('BoodcodeFranceBundle' => 'Boodcode\\FranceBundle\\Entity', 'BoodcodeContactBundle' => 'Boodcode\\ContactBundle\\Entity', 'BoodcodeUserBundle' => 'Boodcode\\UserBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_2ba0d4b4fcf0000da60453afa255137a44c146801f9aac5ea2174d3d5ad38c73');
        return $instance;
    }
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Boodcode\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Boodcode\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Boodcode\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Boodcode\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Boodcode\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['security.encoder_factory'] = new \Symfony\Component\Security\Core\Encoder\EncoderFactory(array('Boodcode\\UserBundle\\Entity\\User' => array('class' => 'Symfony\\Component\\Security\\Core\\Encoder\\MessageDigestPasswordEncoder', 'arguments' => array(0 => 'sha512', 1 => true, 2 => 5000))));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $o = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), '62f752a7f3a6fc3735d24b647f3ee43d40c42220', 'main', array('name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false, 'remember_me_parameter' => '_remember_me'), $a);
        $p = new \Symfony\Component\Security\Http\Firewall\LogoutListener($b, $n, new \Symfony\Component\Security\Http\Logout\DefaultLogoutSuccessHandler($n, '/'), array('csrf_parameter' => '_csrf_token', 'intention' => 'logout', 'logout_path' => '/logout'));
        $p->addHandler(new \Symfony\Component\Security\Http\Logout\SessionLogoutHandler());
        $p->addHandler($o);
        $q = new \Symfony\Component\Security\Http\Authentication\DefaultAuthenticationSuccessHandler($n, array('always_use_default_target_path' => false, 'default_target_path' => '/', 'login_path' => '/login', 'target_path_parameter' => '_target_path', 'use_referer' => false));
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('contact@francoise-aberton.com');
        $a->setPassword('pf4r_F14');
        $a->setAuthMode(NULL);
    ...
    {
        return $this->services['templating.asset.default_package.http'] = new \Symfony\Component\Templating\Asset\UrlPackage(array(0 => 'http://www.francoise-aberton.com/web/bundles/boodcodefrance/'), NULL, '%s?%s');
    }
    protected function getTemplating_Asset_DefaultPackage_SslService()
    {
        ...
        return $this->services['templating.asset.default_package.ssl'] = $this->scopedServices['request']['templating.asset.default_package.ssl'] = new \Symfony\Bundle\FrameworkBundle\Templating\Asset\PathPackage($this->get('request'), NULL, '%s?%s');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/src/Boodcode/FranceBundle/Resources/translations/messages.fr.yml'), 'fr', 'messages');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/src/Boodcode/ContactBundle/Resources/translations/messages.en.yml'), 'en', 'messages');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/src/Boodcode/ContactBundle/Resources/translations/messages.fr.yml'), 'fr', 'messages');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/vich/uploader-bundle/Vich/UploaderBundle/Resources/translations/VichUploaderBundle.en.yml'), 'en', 'VichUploaderBundle');
        $instance->addResource('yml', (dirname(dirname(dirname(__DIR__))).'/vendor/vich/uploader-bundle/Vich/UploaderBundle/Resources/translations/VichUploaderBundle.fr.yml'), 'fr', 'VichUploaderBundle');
        $instance->addResource('xlf', (dirname(dirname(dirname(__DIR__))).'/src/Boodcode/UserBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('boodcode_france.twig.boodcode_extension'));
        $instance->addExtension($this->get('boodcode_france.antispam'));
        ...
        $instance->addExtension($this->get('data_tables.twig.extension'));
        $instance->addGlobal('app', $this->get('templating.globals'));
        $instance->addGlobal('webmaster', 'matt@boodcode.com');
        $instance->addGlobal('site_root', 'http://www.francoise-aberton.com/');
        return $instance;
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Boodcode/FranceBundle/Resources/views'), 'BoodcodeFrance');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Boodcode/ContactBundle/Resources/views'), 'BoodcodeContact');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/vendor/vich/uploader-bundle/Vich/UploaderBundle/Resources/views'), 'VichUploader');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/src/Boodcode/UserBundle/Resources/views'), 'BoodcodeUser');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/vendor/friendsofsymfony/user-bundle/Resources/views'), 'FOSUser');
        $instance->addPath((dirname(dirname(dirname(__DIR__))).'/vendor/brown298/data-tables-bundle/Brown298/DataTablesBundle/Resources/views'), 'Brown298DataTables');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('62f752a7f3a6fc3735d24b647f3ee43d40c42220');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->setConstraintValidatorFactory(new \Symfony\Bundle\FrameworkBundle\Validator\ConstraintValidatorFactory($this, array('validator.expression' => 'validator.expression', 'Symfony\\Component\\Validator\\Constraints\\EmailValidator' => 'validator.email', 'security.validator.user_password' => 'security.validator.user_password', 'doctrine.orm.validator.unique' => 'doctrine.orm.validator.unique', 'boodcode_france_antiflood' => 'boodcode_france.validator.antiflood')));
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        ...
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\DaoAuthenticationProvider($this->get('fos_user.user_provider.username'), $a, 'main', $this->get('security.encoder_factory'), true), 1 => new \Symfony\Component\Security\Core\Authentication\Provider\RememberMeAuthenticationProvider($a, '62f752a7f3a6fc3735d24b647f3ee43d40c42220', 'main'), 2 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('553ec97c9c571')), true);
    ...
    protected function getVichUploader_PropertyMappingFactoryService()
    {
        ...
        return $this->services['vich_uploader.property_mapping_factory'] = new \Vich\UploaderBundle\Mapping\PropertyMappingFactory($this, new \Vich\UploaderBundle\Metadata\MetadataReader($b), array());
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'BoodcodeFranceBundle' => 'Boodcode\\FranceBundle\\BoodcodeFranceBundle',
                'BoodcodeContactBundle' => 'Boodcode\\ContactBundle\\BoodcodeContactBundle',
                'StofDoctrineExtensionsBundle' => 'Stof\\DoctrineExtensionsBundle\\StofDoctrineExtensionsBundle',
                'VichUploaderBundle' => 'Vich\\UploaderBundle\\VichUploaderBundle',
                'BoodcodeUserBundle' => 'Boodcode\\UserBundle\\BoodcodeUserBundle',
                'FOSUserBundle' => 'FOS\\UserBundle\\FOSUserBundle',
                'Brown298DataTablesBundle' => 'Brown298\\DataTablesBundle\\Brown298DataTablesBundle',
            ),
            ...
            'database_port' => '3306',
            'database_name' => 'france_db',
            'database_user' => 'francounette',
            'database_password' => 'france!Pass2014',
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'contact@francoise-aberton.com',
            'mailer_password' => 'pf4r_F14',
            'locale' => 'fr',
            'secret' => '62f752a7f3a6fc3735d24b647f3ee43d40c42220',
            'debug_toolbar' => true,
            'debug_redirects' => false,
            'use_assetic_controller' => true,
            'app_webmaster' => 'matt@boodcode.com',
            'site_root' => 'http://www.francoise-aberton.com/',
            'assets_base_url' => 'http://www.francoise-aberton.com/web/bundles/boodcodefrance/',
            ...
            'kernel.secret' => '62f752a7f3a6fc3735d24b647f3ee43d40c42220',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'contact@francoise-aberton.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'pf4r_F14',
            ...
            'fos_user.model.user.class' => 'Boodcode\\UserBundle\\Entity\\User',
            ...
            'data_tables.service.class' => 'Brown298\\DataTablesBundle\\Service\\ServerProcessService',
            'data_tables.reader.class' => 'Doctrine\\Common\\Annotations\\AnnotationReader',
            'data_tables.manager.class' => 'Brown298\\DataTablesBundle\\Service\\TableManager',
            'data_tables.cache.servicename' => '',
            'data_tables.twig.extension.class' => 'Brown298\\DataTablesBundle\\Twig\\DataTables',
            'data_tables.config_search_path' => array(
                0 => 'dataTable',
            ),
            'data_tables.annotation_search_path' => array(
                0 => 'DataTables',
                1 => 'Model',
                2 => 'Entity',
            ),
