<?php
// src/Boodcode/FranceBundle/Antispam/BoodcodeAntispam.php

namespace Boodcode\FranceBundle\Antispam;

class BoodcodeAntispam extends \Twig_Extension
{
  protected $mailer;
  protected $locale;
  protected $nbForSpam;
